"""
Django settings for your_clothes project.
...
SECRET_KEY = 'django-insecure-c&wrrto#$sari(^jha2am_j&287h_vm0%gf-!tv(wijp@9k0q0'
...
WSGI_APPLICATION = 'your_clothes.wsgi.application'
